...
# This script will:
# 1. List all invoices
# 2. Find a finalized CCF (type "03")
# 3. Get invoice details with line items
# 4. Create a nota de débito adjusting the first line item
# 5. Get the created nota
# 6. Optionally finalize it

set -e

# Configuration
API_URL="http://localhost:8080/v1"
COMPANY_ID="e65fb18b-1944-483c-b877-f11f8f4ad7c3"
...
echo -e "${GREEN}./test_finalize_nota_debito.sh $NOTA_ID${NC}"
echo ""
echo "Or use curl:"
...
echo -e "${GREEN}./test_get_nota_debito.sh $NOTA_ID${NC}"
echo ""
